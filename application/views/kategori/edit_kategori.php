        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="">kategori List</a></li>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('kategori/edit_kategori/'.$this->uri->segment(3)); ?>
              <?php echo validation_errors(); ?>
              <?php foreach ($get_kategori as $key) { ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="">Nama Kategori</label>
                    <input value ="<?php echo $key->nama_kategori ?>" type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Masukkan Nama Kategori" ?>
                  </div>
                <!-- /.card-body -->
